...
export default function CupTieGroup({ legs, onUpdate, canEdit, editMode, broadcasters }) {
  ...
  return (
    <div className="flex flex-col divide-y divide-gray-100">
      {sorted.map((f) => (
        <CupFixtureRow key={f.id} fixture={f} onUpdate={onUpdate} canEdit={canEdit} editMode={editMode} broadcasters={broadcasters} />
      ))}
      {aggregate && (
